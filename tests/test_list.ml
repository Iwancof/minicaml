...
print_string (test_bool (run "List.hd 1" = ( UnOpTypeErr(OHead, IntVal 1))));;
print_string (test_bool (run "List.tl 1" = ( UnOpTypeErr(OTail, IntVal 1))));;

print_string (test_bool (run "1 :: 2" = ( BinOpTypeErr(OCons, IntVal 1, IntVal 2))));;
